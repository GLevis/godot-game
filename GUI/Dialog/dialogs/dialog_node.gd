extends Control
class_name DialogNode, "res://GUI/Dialog/dialogs/icon.svg"
...
export(Resource) var dialog_resource = load("res://GUI/Dialog/dialogs/Resources/DefaultDialogResource.tres")
export(Array, Resource) var dialog_characters

onready var Portrait = load("res://GUI/Dialog/dialogs/Nodes/Portrait.tscn")
var dialog_script = [
	#{
	#	'fade-in': 2
	#},
	{
		'background': "res://GUI/Dialog/dialogs/Images/background/placeholder-2.png"
	},
	{
		'character': 'Iteb',
		'position': 'center',
